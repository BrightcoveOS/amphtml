...
Automatically start playback. Browsers may restrict automatic playback, for example only permit if the video is muted.
...
On iOS 10, indicates that the video should play inline instead of fullscreen.
